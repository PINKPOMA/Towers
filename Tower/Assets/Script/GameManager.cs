...
public class GameManager : Singleton<GameManager>
{
    ...
    public CanonInformation[][] CanonData = 
    {
        ...
        new CanonInformation[] // Laser Canon
        {
            ...
            new CanonInformation {Damage = 4, AttackDelay = 2, Cost = 25, Range = 2}, // Level 2
            new CanonInformation {Damage = 5, AttackDelay = 1, Cost = 30, Range = 3}, // Level 3
        },
        new CanonInformation[] // Slow Canon
        {
            // Extra : Slow Down Enemy Speed Percent for 5 Seconds
            new CanonInformation {Damage = 3, AttackDelay = 1, Cost = 20, Range = 3, Extra = 10}, // Level 1
            new CanonInformation {Damage = 3, AttackDelay = 1, Cost = 50, Range = 3, Extra = 20}, // Level 2
            new CanonInformation {Damage = 3, AttackDelay = 1, Cost = 70, Range = 3, Extra = 40}, // Level 3
        }
    };
